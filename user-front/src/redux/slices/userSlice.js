...
import { GET_ALL_USERS, CREATE_USER, UPDATE_USER, DELETE_USER } from "../../graphql/requires";
...
export const updateUser = createAsyncThunk("users/updateUser", async ({ userId, userInput }) => {
  const { data } = await client.mutate({
